...
(
    ...
    DESCRIPTION VARCHAR(1000) DEFAULT NULL UNIQUE CHECK (LENGTH(DESCRIPTION) >=  20),
...
(
    ...
    OPEN_POSITIONS                INTEGER NOT NULL CHECK (OPEN_POSITIONS >= 1 AND OPEN_POSITIONS <=60),
...
(
    ...
    LINKEDIN_URL VARCHAR(100) DEFAULT NULL UNIQUE CHECK (LENGTH(LINKEDIN_URL) >= 15),
