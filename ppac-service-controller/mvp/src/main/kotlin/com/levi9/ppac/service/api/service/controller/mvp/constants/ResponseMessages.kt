...
object ResponseMessages {
    ...
    const val CREATED = "Your resource was created."
    ...
    const val MISSING_HEADER = "The request is missing the required header. Please ensure that you include the header in your request header and try again."
